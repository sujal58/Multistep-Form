...
function Navbar() {
  return (
    <>
    <div className="hidden sm:block pt-6 bg-cover h-[28rem] w-3/12 bg-center rounded-xl" style={{backgroundImage:`url(${sidebarIMG})`}}>
             <div className="absolute sm:static top-5 gap-6 left-1/3 right-1/3 flex justify-center items-center sm:flex-col rounded-xl sm:p-1 md:p-4 font-ubuntu">
                  <div className='flex items-center text-white sm:gap-3 w-full'>
                    ...
                    <div className='hidden sm:block'>
                      ...
                      <p className=' text-xs font-bold text-gray-200'>YOUR INFO</p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-center text-white gap-3 w-full'>
                      ...
                      <div className='hidden sm:block'>
                        ...
                        <h2 className='text-xs md:text-xs font-bold text-gray-200'>SELECT PLAN</h2>
                      </div>
                  </div>
                ...
                <div className='flex justify-start items-center text-white gap-3 w-full'>
                  ...
                  <div className='hidden sm:block'>
                    ...
                    <h2 className='text-xs md:text-xs font-bold text-gray-200'>ADD-ONS</h2>
                  </div>
                </div>
                ...
                <div className='flex items-center text-white gap-3 w-full'>
                  ...
                  <div className='hidden sm:block'>
                    ...
                    <h2 className='text-xs sm:text-xs font-bold text-gray-200'>SUMMARY</h2>
                  </div>
                </div>
            </div> 
        </div>
