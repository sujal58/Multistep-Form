    ...
    <div className="min-h-screen flex sm:justify-center items-center bg-gray-200 font-ubuntu">
        <div className="sm:static flex flex-col sm:flex-row sm:bg-white sm:h-full w-8/12 lg:w-6/12 xl:w-7/12 sm:p-4 rounded-xl">
              ...
              <div className="absolute top-20 sm:static flex justify-center w-full sm:flex-1">
                <div className="bg-white py-6 sm:py-10 rounded-xl w-11/12 sm:h-full p-4 sm:p-2 md:p-6 md:ml-5 flex flex-col gap-3 md:gap-5">
                  ...
                  <div className="details flex flex-col gap-2 sm:gap-5">
                    <div className='personName gap-1'>
                      ...
                      <input type="text" className='border pl-2 border-solid border-gray-500 rounded-md text-md sm:text-xs w-11/12 h-8 sm:h-9' placeholder='e.g.Stephen King'/>
                    </div>
                    
                    <div className='personEmail'>
                      <h2 className='text-blue-900'>Email Address</h2>
                      <input type="email" className='border pl-2 border-solid border-gray-500 rounded-md text-sm sm:text-xs w-11/12 h-8 sm:h-9' placeholder='e.g.stephenKing@lorem.com'/>
                    </div>

                    <div className='personPhone'>
                     <h2 className='text-blue-900'>Phone Number</h2>
                      <input type="text" className='border pl-2 border-solid border-gray-500 rounded-md text-sm sm:text-xs w-11/12 h-8 sm:h-9' placeholder='e.g.+1 234 567 890'/>
                    </div>
